...
| claude-sdk-ts | ts | @anthropic-ai/claude-agent-sdk | PreToolUse hookSpecificOutput.permissionDecision + Options.canUseTool | 0.0.4 | 0.3.233 | 0.3.233 | @anthropic-ai/claude-agent-sdk 0.0.4 :: package/sdkTypes.d.ts:120 export type CanUseTool; :203-206 hookSpecificOutput.permissionDecision; :224 Options.canUseTool. First published tarball (npm registry has no 0.0.1-0.0.3). 0.3.233 :: package/sdk.d.ts:206 export declare type CanUseTool; :1406 Options.canUseTool; :2334-2336 type PreToolUseHookSpecificOutput.permissionDecision. Floor is the verified native contract at latest inspected, not first symbol appearance. |
